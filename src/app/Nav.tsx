  ...
  [
    {
      title: "시리즈",
      subLinks: [
        { name: "전체", href: "/game-list" },
        { name: "마리오", href: "/game-list" },
        { name: "포켓몬", href: "/game-list" },
        { name: "젤다의 전설", href: "/game-list" },
        { name: "커비", href: "/game-list" },
        { name: "동물의 숲", href: "/game-list" },
      ],
    },
    {
      title: "출시 년도",
      subLinks: [
        { name: "2024", href: "/game-list" },
        { name: "2023", href: "/game-list" },
        { name: "2022", href: "/game-list" },
        { name: "2021", href: "/game-list" },
        { name: "2020", href: "/game-list" },
      ],
    },
  ],
  [
